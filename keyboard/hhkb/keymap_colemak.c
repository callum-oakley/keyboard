...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    KEYMAP(F12,   F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10, F11,MUTE,VOLD,VOLU, \
           TAB,    Q,   W,   F,   P,   G,   J,   L,   U,   Y,SCLN, DEL,CAPS, FN4,      \
           BSPC,   A,   R,   S,   T,   D,   H,   N,   E,   I,   O,QUOT, ENT,           \
           FN1,    Z,   X,   C,   V,   B,   K,   M,COMM, DOT,SLSH, FN2, FN3,           \
                LALT,LCTL,           FN0,                LGUI,RALT),

    KEYMAP(F12,   F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10, F11,PSCR,PAUS,TRNS, \
           GRV,    1,   2,   3,   4,   5,   6,   7,   8,   9,   0,MINS,TRNS,TRNS,      \
    ...
    KEYMAP(TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,MPLY,MPRV,MNXT,TRNS, \
           TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PSCR,TRNS,      \
           TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,           \
           TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PAUS,           \
                TRNS,TRNS,          TRNS,               TRNS,TRNS),
};
